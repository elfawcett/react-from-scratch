...
export const mockJokes: IJoke[] = [
  ...
  { id: 21, joke: "Chuck Norris doesn't shower, he only takes blood baths.", categories: [] },
  { id: 23, joke: 'Time waits for no man. Unless that man is Chuck Norris.', categories: [] },
  {
    id: 24,
    joke:
